<?php
// Основной лог для вывода сообщений предупреждений
const LOCAL_LOG_LEVEL_WARN = 'warning';
return [
    'class' => 'yii\log\FileTarget',
    'levels' => [LOCAL_LOG_LEVEL_WARN],
    'logFile' => '@logs/' . LOCAL_LOG_LEVEL_WARN . '/' . date('Y-m-d') . '_' . LOCAL_LOG_LEVEL_WARN . '.log',
