<?php
// Основной лог для информационных сообщений
const LOCAL_LOG_LEVEL_INFO = 'info';
return [
    'class' => 'yii\log\FileTarget',
    'levels' => [LOCAL_LOG_LEVEL_INFO],
    'logFile' => '@logs/' . LOCAL_LOG_LEVEL_INFO . '/' . date('Y-m-d') . '_' . LOCAL_LOG_LEVEL_INFO . '.log',
